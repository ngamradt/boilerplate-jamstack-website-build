...
import timeTZ2day from '../src/timeTZ2day.mjs'


describe(`timeTZ2day`, function() {
    ...
    it(`should return '' when input '125abc'`, function() {
        let r = timeTZ2day('125abc')
        assert.strict.deepStrictEqual(r, '')
    })

    it(`should return '' when input 'abc125'`, function() {
        let r = timeTZ2day('abc125')
        assert.strict.deepStrictEqual(r, '')
    })
    ...
    it(`should return '' when input { a: 123, b: null, c: [45.67] }`, function() {
        let r = timeTZ2day({ a: 123, b: null, c: [45.67] })
        assert.strict.deepStrictEqual(r, '')
    })

    it(`should return '' when input null`, function() {
        let r = timeTZ2day(null)
        assert.strict.deepStrictEqual(r, '')
    })

    it(`should return '' when input undefined`, function() {
        let r = timeTZ2day(undefined)
        assert.strict.deepStrictEqual(r, '')
    })
