...
describe(`istimems`, function() {
    ...
    it(`should return false when input { a: 123, b: null, c: [45.67] }`, function() {
        let r = istimems({ a: 123, b: null, c: [45.67] })
        assert.strict.deepStrictEqual(r, false)
    })
