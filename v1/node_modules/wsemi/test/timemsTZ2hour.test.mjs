...
describe(`timemsTZ2hour`, function() {
    ...
    it(`should return '2019-01-02T12' when input '2019-01-02T12:34:56.987Z'`, function() {
        let r = timemsTZ2hour('2019-01-02T12:34:56.987Z')
        assert.strict.deepStrictEqual(r, '2019-01-02T12')
    })

    it(`should return '2019-01-02T12' when input '2019-01-02T12:34:56.987+08:00'`, function() {
        let r = timemsTZ2hour('2019-01-02T12:34:56.987+08:00')
        assert.strict.deepStrictEqual(r, '2019-01-02T12')
    })
    ...
    it(`should return '' when input '125abc'`, function() {
        let r = timemsTZ2hour('125abc')
        assert.strict.deepStrictEqual(r, '')
    })

    it(`should return '' when input 'abc125'`, function() {
        let r = timemsTZ2hour('abc125')
        assert.strict.deepStrictEqual(r, '')
    })
    ...
    it(`should return '' when input '中文'`, function() {
        let r = timemsTZ2hour('中文')
        assert.strict.deepStrictEqual(r, '')
    })

    it(`should return '' when input 'abc中文'`, function() {
        let r = timemsTZ2hour('abc中文')
        assert.strict.deepStrictEqual(r, '')
    })
    ...
    it(`should return '' when input { a: 123, b: null, c: [45.67] }`, function() {
        let r = timemsTZ2hour({ a: 123, b: null, c: [45.67] })
        assert.strict.deepStrictEqual(r, '')
    })

    it(`should return '' when input null`, function() {
        let r = timemsTZ2hour(null)
        assert.strict.deepStrictEqual(r, '')
    })

    it(`should return '' when input undefined`, function() {
        let r = timemsTZ2hour(undefined)
        assert.strict.deepStrictEqual(r, '')
    })
