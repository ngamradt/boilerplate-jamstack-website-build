...
describe(`time2hour`, function() {
    ...
    it(`should return '' when input '2019+08:00'`, function() {
        let r = time2hour('2019+08:00')
        assert.strict.deepStrictEqual(r, '')
    })

    it(`should return '' when input '2019'`, function() {
        let r = time2hour('2019')
        assert.strict.deepStrictEqual(r, '')
    })
