...
describe(`timemsTZ2time`, function() {
    ...
    it(`should return '2019-01-02T12:34:56' when input '2019-01-02T12:34:56.987Z'`, function() {
        let r = timemsTZ2time('2019-01-02T12:34:56.987Z')
        assert.strict.deepStrictEqual(r, '2019-01-02T12:34:56')
    })

    it(`should return '2019-01-02T12:34:56' when input '2019-01-02T12:34:56.987+08:00'`, function() {
        let r = timemsTZ2time('2019-01-02T12:34:56.987+08:00')
        assert.strict.deepStrictEqual(r, '2019-01-02T12:34:56')
    })
    ...
    it(`should return '' when input '125abc'`, function() {
        let r = timemsTZ2time('125abc')
        assert.strict.deepStrictEqual(r, '')
    })

    it(`should return '' when input 'abc125'`, function() {
        let r = timemsTZ2time('abc125')
        assert.strict.deepStrictEqual(r, '')
    })
    ...
    it(`should return '' when input '中文'`, function() {
        let r = timemsTZ2time('中文')
        assert.strict.deepStrictEqual(r, '')
    })

    it(`should return '' when input 'abc中文'`, function() {
        let r = timemsTZ2time('abc中文')
        assert.strict.deepStrictEqual(r, '')
    })
    ...
    it(`should return '' when input { a: 123, b: null, c: [45.67] }`, function() {
        let r = timemsTZ2time({ a: 123, b: null, c: [45.67] })
        assert.strict.deepStrictEqual(r, '')
    })

    it(`should return '' when input null`, function() {
        let r = timemsTZ2time(null)
        assert.strict.deepStrictEqual(r, '')
    })

    it(`should return '' when input undefined`, function() {
        let r = timemsTZ2time(undefined)
        assert.strict.deepStrictEqual(r, '')
    })
