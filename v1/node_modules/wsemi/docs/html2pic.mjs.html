...
<head>
    ...
    <meta charset="utf-8">
    <title>html2pic.mjs - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">html2pic.mjs</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>//import html2canvas from 'html2canvas' //html2canvas.js沒有umd版, 故引用後會有未檢查window的殼層程式碼出現, 導致無法於nodejs環境下使用wsemi
