...
<head>
    ...
    <meta charset="utf-8">
    <title>isStrHasLowerCase.mjs - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">isStrHasLowerCase.mjs</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import isestr from './isestr.mjs'


/**
 * 字串是否包含小寫英文字元
 *
 * Unit Test: {@link https://github.com/yuda-lyu/wsemi/blob/master/test/isStrHasLowerCase.test.mjs Github}
 * @memberOf wsemi
