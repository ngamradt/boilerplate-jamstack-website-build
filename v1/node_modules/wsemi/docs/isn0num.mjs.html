...
<head>
    ...
    <meta charset="utf-8">
    <title>isn0num.mjs - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">isn0num.mjs</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import isnum from './isnum.mjs'
 ...
 * 非正浮點數包含0
 *
 * Unit Test: {@link https://github.com/yuda-lyu/wsemi/blob/master/test/isn0num.test.mjs Github}
 * @memberOf wsemi
 * @param {*} v 輸入任意資料
