...
<head>
    ...
    <meta charset="utf-8">
    <title>html2str.mjs - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">html2str.mjs</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import htmlparser from 'htmlparser' //要能於nodejs下運行, 故不使用瀏覽器動態加載
