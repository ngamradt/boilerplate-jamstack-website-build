...
<head>
    ...
    <meta charset="utf-8">
    <title>ocr.mjs - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">ocr.mjs</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import tesseract from 'tesseract.js' //要能於nodejs下運行, 故不使用瀏覽器動態加載
