...
<head>
    ...
    <meta charset="utf-8">
    <title>domConvertToPic.mjs - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">domConvertToPic.mjs</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>//import htmlToImage from 'htmlToImage' //htmlToImage.js沒有umd版, 故引用後會有未檢查window的殼層程式碼出現, 導致無法於nodejs環境下使用wsemi
