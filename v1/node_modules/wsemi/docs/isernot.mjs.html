...
<head>
    ...
    <meta charset="utf-8">
    <title>isernot.mjs - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">isernot.mjs</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import iser from './iser.mjs'


/**
 * 判斷是否為廣義有效
 *
 * Unit Test: {@link https://github.com/yuda-lyu/wsemi/blob/master/test/isernot.test.mjs Github}
 * @memberOf wsemi
 * @param {*} v 輸入任意資料
